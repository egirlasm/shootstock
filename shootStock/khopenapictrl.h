...
//
	...
	long SendCondition(LPCTSTR strScrNo, LPCTSTR strConditionName, long nIndex, long nSearch)
	{
		long result;
		static BYTE parms[] = VTS_BSTR VTS_BSTR VTS_I4 VTS_I4 ;
		InvokeHelper(0x36, DISPATCH_METHOD, VT_I4, (void*)&result, parms, strScrNo, strConditionName, nIndex, nSearch);
		return result;
	}
	void SendConditionStop(LPCTSTR strScrNo, LPCTSTR strConditionName, long nIndex)
	{
